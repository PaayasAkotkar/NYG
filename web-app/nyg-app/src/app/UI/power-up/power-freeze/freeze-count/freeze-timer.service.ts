...
import { BehaviorSubject, Observable, ReplaySubject, scan, startWith, Subject, switchMap, takeUntil, takeWhile, tap, timer } from 'rxjs';
...
export class FreezeTimerService {
