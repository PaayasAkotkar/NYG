...
@Component({
  selector: 'app-locify-clock',
  imports: [],
  templateUrl: './locify-clock.component.html',
  styleUrls: ['./touchup/clock.scss', './touchup/color.scss', './touchup/animation.scss']

})
export class LocifyClockComponent {
  @Input({ required: true }) NYGdiscussionSec: number = 30
  ...
  ngOnInit(): void {
    console.log('dtime: ', this.NYGdiscussionSec)
  }
