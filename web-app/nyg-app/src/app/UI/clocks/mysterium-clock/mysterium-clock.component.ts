...
@Component({
  selector: 'app-mysterium-clock',
  imports: [],
  templateUrl: './mysterium-clock.component.html',
  styleUrls: ['./touchup/clock.scss', './touchup/color.scss', './touchup/animation.scss']
})
export class MysteriumClockComponent {
  @Input({ required: true }) NYGdiscussionSec: number = 3
