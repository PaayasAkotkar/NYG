...
replace nyg/validation => ../validation

require (
	app/nygprotoc v0.0.0-00010101000000-000000000000
	github.com/gofiber/contrib/websocket v1.3.4
	github.com/gofiber/fiber/v2 v2.52.6
	github.com/google/uuid v1.6.0
	github.com/stretchr/testify v1.10.0
	google.golang.org/grpc v1.76.0
	nyg/deck v0.0.0-00010101000000-000000000000
	nyg/dictionary v0.0.0-00010101000000-000000000000
	nyg/list v0.0.0-00010101000000-000000000000
	nyg/profiles v0.0.0-00010101000000-000000000000
	nyg/validate v0.0.0-00010101000000-000000000000
)
